...
def handle_brk_enter_event(cpu, raw_data, size, tracker: MemoryTracker, target_pids, trace_all):
...
def handle_brk_exit_event(cpu, raw_data, size, tracker: MemoryTracker, target_pids, trace_all):
